...
class M_global extends CI_Model
{
    ...
    /**
     *  mengakomodir untuk proses where in (a,b,c,d,e)
     *  author : Moch Zawaruddin A
     * @var array
     */
    protected $where_in = [];
    ...
    /**
     * mengakomodir untuk proses sorting lebih dari 1 kolom
     *
        [
            ['kolom_1', 'ASC/DESC'],
            ['kolom_2', 'ASC/DESC'],
	...
	public function count(array $params = array())
	{
        ...
        /*
         *  untuk mengakomodir query where in
         *  author : Moch Zawaruddin A
         * */
        if(is_array($data->where_in) && count($data->where_in) > 0){
	...
	public function get(array $params = array())
	{
        ...
        /*
         *  untuk mengakomodir order by multi column
         *  author : Moch Zawaruddin A
         * */
        if(is_array($data->order_multi) && count($data->order_multi) > 0){
            foreach($data->order_multi as $o) {
