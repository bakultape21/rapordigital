...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="keywords" content="E- Rapor" />
    <script>
...
<body>
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                <h1 class="wthree-logo">
                    <a href="index.html" id="logoLink">E Rapor</a>
                </h1>
 ...
 -->            </div>
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url() ?>/user/login" target="_blank">Login</a>
                    <a href="<?= base_url() ?>/user/login/register" class="text-white">Register</a>
                </div>
            </div>
        </div>
    </header>
