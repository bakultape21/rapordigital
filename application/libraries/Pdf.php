...
class Pdf extends FPDF {
    ...
    // Page number
		...
		$this->Cell(10,0,'PT Total Industri', 0, 0, 'L');
		$this->SetFont('Arial','I',9);
		$this->Cell(0,0,'Halaman '.$this->PageNo().' dari {nb} halaman', 0, 1, 'R');
		$this->SetFont('Arial','',8);
		$this->ln(2);
		$this->Cell(10,3,'Menara Rajawali Level 7-1', 0, 1, 'L');
		$this->Cell(10,3,'Jl. DR. Ide Anak Agung Gde Agung', 0, 1, 'L');
		$this->Cell(10,3,'Kawasan Mega Kuningan, Kecamatan Setiabudi,', 0, 1, 'L');

		$this->Cell(10,3,'Jakarta Selatan12950,', 0, 1, 'L');
