<div class="kt-portlet">
	<div class="kt-portlet__head">
		<div class="kt-portlet__head-label">
			...
			<i class="flaticon2-plus-1"></i> Form Nilai Ekstra
			</h3>
		</div>
				...
				<table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $key->alamat; $i++; ?></td>
							<td>
								<?php if ($key->nilai_ekstra_id== null) { ?>
								<a href="<?php echo $url; ?>/Nilai_ekstra/show_add/<?= ($key->siswa_kelas_id) ?>" class="ajaxify" aria-haspopup="true" >
									<button class="btn btn-sm btn-success">Input Nilai Ekstra</button>
								</a>
							<?php }else{ ?>
								<a href="<?php echo $url; ?>/Nilai_ekstra/show_edit/<?= ($key->siswa_kelas_id) ?>" class="ajaxify" aria-haspopup="true" >
									<button class="btn btn-sm btn-warning">Edit Nilai Ekstra</button>
								</a>
							<?php } ?>
							</td>
						</tr>
