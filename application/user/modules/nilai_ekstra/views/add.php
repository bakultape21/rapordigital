	...
	<div class="kt-portlet__head">
		...
		<div class="kt-portlet__head-toolbar">
			<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
				<a href="<?php echo base_url(); ?>/nilai_ekstra/index/<?= ($record->kelas_id); ?>" class="ajaxify btn btn-brand" aria-haspopup="true">
		...
		<form class="kt-form" id="form-action" data-multipart='1' action="<?php echo $url; ?>/action_add/<?= $id ?>" autocomplete="off">
			<div class="row">
				...
				<div class="col-md-12 text-center">
					<a href="<?php echo base_url(); ?>/Nilai_ekstra/index/<?= ($record->kelas_id); ?>" class="ajaxify btn btn-warning btn-elevate btn-square">Back</a>
					<button type="submit" class="btn btn-brand btn-elevate btn-square">Save</button>
				</div>
			</div>
		</form>
	</div>
	<a href="<?php echo base_url(); ?>/nilai_ekstra/index/<?= ($record->kelas_id); ?>" class="ajaxify reload"></a>
</div>
