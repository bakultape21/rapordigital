	...
	<div class="kt-portlet__head">
		...
		<div class="kt-portlet__head-toolbar">
			<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
				<button type="button"  class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalSekolah">
				  Laporan Sekolah
				</button>
			</div>
		</div>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td><?= $key->nip ?></td>
							<td><?= $key->guru_nama; ?></td>
							<td><button type="button"  class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal<?= strEncrypt($key->guru_id) ?>">
							  Laporan
							</button>
						</td>
						</tr>
						  ...
						  <div class="modal-dialog" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <form method="post" target="_blank" action= "<?= base_url() ?>/laporan_penilaian/action_laporan/guru/<?= strEncrypt($key->guru_id) ?>">
						        	<div class="form-group">
...
<div class="modal fade" id="modalSekolah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title" id="exampleModalLabel">Cetak Laporan Sekolah</h5>
			      </div>
			      <div class="modal-body">
			        <form method="post" target="_blank" action= "<?= base_url() ?>Laporan_penilaian/action_laporan/sekolah/<?= $id ?>">
			        	<div class="form-group">
			        		<label>Semester</label> <br>
			        		<input type="radio" name="semester" value="1"> Ganjil <br>
			        		<input type="radio" name="semester" value="2"> Genap <br>
