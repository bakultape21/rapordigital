	...
	<div class="container">
		<div class="col-md-12">
			<div class="form-group">
				<h3>Cetak Data Peserta Didik </h3> <br>
					...
					<div class="col-md-12 row">
						<table class="table text-left" style="">
								...
								<tr class="text">
									<td></td>
									<td>- Nama Lengkap</td>
									<td colspan="2"><?= $data_siswa->nama_lengkap ?></td>
								</tr>
								<tr class="text">
									<td></td>
									<td>- Nama Panggilan</td>
									<td colspan="2"><?= $data_siswa->nama_panggilan ?></td>
								</tr>

								<tr class="text">
									<td>2</td>
									<td>Nomor Induk</td>
									<td colspan="2"><?= $data_siswa->no_induk ?></td>
								</tr>
								<tr class="text">
									<td>3</td>
									<td>Tempat, Tanggal Lahir</td>
									<td colspan="2"><?= strtoupper($data_siswa->tempat_lahir).', '.tgl_indo($data_siswa->tanggal_lahir) ?></td>
								</tr>
								<tr class="text">
									<td>4</td>
									<td>Jenis Kelamin</td>
									<td colspan="2"><?= $jenis_kelamin[$data_siswa->jenis_kelamin] ?></td>
								</tr>
								<tr class="text">
									<td>5</td>
									<td>Agama</td>
									<td colspan="2"><?= $agama[$data_siswa->agama] ?></td>
								</tr>
								<tr class="text">
									<td>6</td>
									<td>Alamat Tumah</td>
									<td colspan="2"><?= $data_siswa->alamat ?></td>
								</tr>
								<tr class="text">
									<td>7</td>
									<td>Orang tua</td>
								...
								<tr class="text">
									<td></td>
									<td>- Ayah</td>
									<td colspan="2"><?= $data_siswa->nama_ayah ?></td>
								</tr>
								<tr class="text">
									<td></td>
									<td>- Ibu</td>
									<td colspan="2"><?= $data_siswa->nama_ibu ?></td>
								</tr>
								<tr class="text">
									<td>8</td>
									...
									<td></td>
									<td>- Ayah</td>
									<td colspan="2"><?= $data_siswa->pekerjaan_ayah ?></td>
								</tr>
								<tr class="text">
									<td></td>
									<td>- Ibu</td>
									<td colspan="2"><?= $data_siswa->pekerjaan_ibu ?></td>
								</tr>
							...
							<table class="table">
								<tr>
									<td width="30%"></td>
									<td width="30%"></td>
									<td width="30%"><?=$data_siswa->kabupaten.', '.tgl_indo($data_siswa->tanggal_raport_cetak) ?>
										<br>
								...
								<tr class="text-right">
									<td width="30%"></td>
									<td width="30%"><br><br>Foto 3x4 <br><br><br><br></td>
									<td width="30%">
									</td>
								</tr>
								...
								<tr>
									<td width="30%"></td>
									<td width="30%"></td>
									<td width="30%" class="text-bold">(<?=$data_siswa->kepala_sekolah?>)
										<br>
