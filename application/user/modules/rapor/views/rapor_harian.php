...
function preview_image(id) 
		...
		function  get_modal_cetak_data(id, nama_siswa) {
			...
			setCetakLink("cetak_rapor_harian", "<?= site_url() ?>/rapor/cetak_rapor_harian/"+ id);

			setCetakLink("cetak_rapor_harian_html", "<?= site_url() ?>/rapor/cetak_rapor_harian/"+ id+"/0/html");

			setCetakLink("cetak_rapor_harian_foto", "<?= site_url() ?>/rapor/cetak_rapor_harian_foto/" + id);

			setCetakLink("cetak_rapor_harian_foto_html", "<?= site_url() ?>/rapor/cetak_rapor_harian_foto/" + id+"/0/html");

			setCetakLink("cetak_rapor_harian_w", "<?= site_url() ?>/rapor/cetak_rapor_harian/"+ id + '/1');

			setCetakLink("cetak_rapor_harian_w_html", "<?= site_url() ?>/rapor/cetak_rapor_harian/"+ id + '/1/html');

			setCetakLink("cetak_rapor_harian_foto_w", "<?= site_url() ?>/rapor/cetak_rapor_harian_foto/" + id + '/1');

			setCetakLink("cetak_rapor_harian_foto_w_html", "<?= site_url() ?>/rapor/cetak_rapor_harian_foto/" + id + '/1/html');
