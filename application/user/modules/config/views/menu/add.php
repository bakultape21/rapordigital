<div class="kt-portlet">
	...
	<div class="kt-portlet__body">
		<form class="kt-form" id="form-action" action="<?php echo $url; ?>/action_add" autocomplete="off">
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Label : <span class="required">*</span></label>
						<input type="text" required name="label" class="form-control" placeholder="Label">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" required name="icon" class="form-control lowercase" placeholder="Icon">
					...
					<div class="form-group">
						...
						<div class="kt-radio-inline">
							<label class="kt-radio kt-radio--solid kt-radio--brand">
								<input type="radio" value="1" checked name="position"> Parent
								<span></span>
							</label>
							<label class="kt-radio kt-radio--solid kt-radio--success">
								<input type="radio" value="0" name="position"> Children
								<span></span>
							</label>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<select id="user_role" name="parent" class="form-control select2" placeholder="Parent">
							...
							<?php foreach ($parent as $key => $val): ?>
								<option value="<?php echo $val->menu_id; ?>"><?php echo $val->menu_label; ?></option>
							<?php endforeach ?>
						</select>
					</div>
				</div>
