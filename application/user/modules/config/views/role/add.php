					...
					<div class="form-group">
						...
						<div class="kt-checkbox-inline">
							<label class="kt-checkbox kt-checkbox--solid kt-checkbox--brand">
								<input type="checkbox" value="r" checked name="read"> Read
								<span></span>
							</label>
							<label class="kt-checkbox kt-checkbox--solid kt-checkbox--success">
								<input type="checkbox" value="w" name="write"> Edit
								<span></span>
							</label>
							<label class="kt-checkbox kt-checkbox--solid kt-checkbox--danger">
								<input type="checkbox" value="d" name="delete"> Delete
								<span></span>
							</label>
						</div>
					</div>
					<div style="display: none;">
						<textarea required readonly name="access" id="inputTree"></textarea>
					</div>
				</div>
				<div class="col-md-8">
					<div class="form-group">
