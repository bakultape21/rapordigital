            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Rapor Digital</h1>
	                        <p class="hero-paragraph">Adalah Sisten Rekapitulasi Pelaporan administrasi dalam aplikasi penilaian berbasis internet / Online untuk tingkat Taman Kanak-kanak, PAUD & Sederajat.</p>
							<div class="hero-form field field-grouped">
								
								<div class="control">
									<a class="button button-primary button-block" href="<?= site_url() ?>/login/register">Start Now!</a>
								</div>
							</div>
						</div>
										...
										<g class="anime-element fadeleft-animation">
											<g transform="translate(56 157)">
												...
												<g transform="translate(28 232)">
													...
													<image mask="url(#hero-illustration-l)" x="-2" width="33" height="33" href="<?= base_url() ?>../assets/profile/src/logo.png"/>
												</g>
                    ...
                    <div class="features-inner section-inner">
                        <div class="features-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">Kenapa Rapor Digital?</h2>
                                <p class="section-paragraph">Rapor Digital Memiliki Banyak Manfaat dan Di Kembangkan Secara Khusus Untuk Guru TK/PAUD/KB/SPS</p>
                            </div>
                        </div>
						<div class="features-wrap">
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Aplikasi dapat digunakan 7x24 jam non stop dan memiliki kecepatan pemerosesan secara <b>realtime</b></p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Responsive</h4>
                                    <p class="text-sm">Dapat digunakan di semua perangkat keras <b>Leptop/PC/Smartphone/Tablet</b></p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Semua Kurikulum</h4>
                                    <p class="text-sm">Dapat digunakan dengan oleh bermacam-macam kurikulum dan <b>menyesuaikan kebutuhan lembaga</b>.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Full Support</h4>
                                    <p class="text-sm">Layanan Customer Service <b>7x24 Jam</b> dan pembimbingan sampai bisa..</p>
                                </div>
                            </div>
						</div>
                    </div>
			...
			<section class="testimonials section">
				...
				<div class="container">
					<div class="testimonials-inner section-inner">
						<h2 class="section-title mt-0 text-center hover-underline-animation">Partnership</h2>
						<div class="testimonials-wrap">
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="<?= base_url() ?>../assets/igtki.png" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">IGTKI - Ikatan Guru Taman Kanak-kanak Indonesia</p>
										</div>
									</div>
							...
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="<?= base_url() ?>../assets/pgri.png" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">PGRI - Persatuan Guru Republik Indonesia</p>
										</div>
									</div>
									<!-- <div class="testimonial-footer">
										<div class="testimonial-link">
							...
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="<?= base_url() ?>../assets/paud.jpeg" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">PAUD - Pendidikan Anak Usia Dini</p>
										</div>
									</div>
									<!-- <div class="testimonial-footer">
										<div class="testimonial-link">
						...
						<div class="testimonials-wrap">
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="<?= base_url() ?>../assets/muslimat.jpg" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">TK Muslimat NU </p>
										</div>
									</div>
									<!-- div class="testimonial-footer">
										<div class="testimonial-link">
							...
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="<?= base_url() ?>../assets/aisiyah.png" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">TK Aisiyah</p>
										</div>
									</div>
									<!-- <div class="testimonial-footer">
										<div class="testimonial-link">
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center">
                            <h2 class="section-title mt-0">Ayo Bergabung ke Rapordigital.com</h2>
