...
class Analisa_cp extends MX_Controller
{
	...
	public function cetak(){
		...
		$data['elemen']= $this->m_global->get(['table'=> 't_sekolah_elemen_data sd', 
			...
			'where'=> [
				's.sekolah_id'=> $data['guru_sekolah']->sekolah_id, 
		...
		$data['siswa']= $this->m_global->get([
			...
			'where'=> ['td.siswa_kelas_id'=> $_POST['siswa_kelas_id'], 'sekolah_elemen_status'=> 1,],
			'group'=> 's.siswa_id',
