...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		<div class="kt-portlet__head-label">
			<h3 class="kt-portlet__head-title">
				<i class="fa fa-table"></i> Laporan Bulanan TP/TK/ Nilai Belajar
			</h3>
		</div>
	...
	<div class="kt-portlet__body">
		<div class="row">
			<div class="col-md-12">
					<form method="post" action="<?= site_url() ?>/laporan_bulanan/action_laporan_bulanan" target="_blank">
						<div class="col-sm-6">
							<h3><label>Cetak Rekap Nilai Kegiatan/TP/TK Bulanan</label></h3>
							...
							<div class="form-group">
								...
								<input type="text" name="awal" value="<?= date('Y-m-d', strtotime('-28 days')) ?>" class="form-control datepicker" autocomplete="off">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Judul Laporan Bulan</label>
								<input type="text" name="judul" class="form-control" value="Bulan I" autocomplete="off">
							</div>
							<div class="form-group">
