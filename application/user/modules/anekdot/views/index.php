	...
	<div class="kt-portlet__head">
		<div class="kt-portlet__head-label">
			<h3 class="kt-portlet__head-title">
				<i class="fa fa-table"></i> Catatan Anekdot
			</h3>
		</div>
		<div class="kt-portlet__head-toolbar">
			<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
				
				<a href="<?php echo site_url() ?>/anekdot" class="ajaxify btn btn-brand" aria-haspopup="true">
	...
	<div class="kt-portlet__body">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="kt-portlet__body">
					<h3>Buat Catatan Anekdot Dari Nilai</h3>
					<form>
						...
						<div class="form-group">
							...
							<div class="form-group">
								<button type="button" onclick="get_form()" class="btn btn-success btn-sm">Tampilkan Form Anekdot</button>
							</div>
					</form>
				</div>
				...
				<div class="col-md-12">
					<h3>Form Catatan Anekdot</h3>
					<form class="kt-form" id="form-action" data-multipart='1' data-reload='1' action="<?php echo $url; ?>/save_catatan_anekdot" autocomplete="off">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>Kelas</label>
						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th width="20%">Capaian Belajar</th>
									<th width="20%">Umpan Balik</th>
...
<a href="<?php echo base_url(); ?>/anekdot; ?>" class="ajaxify reload"></a>
