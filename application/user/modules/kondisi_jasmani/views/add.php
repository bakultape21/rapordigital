<div class="kt-portlet">
	...
	<div class="kt-portlet__body">
		<form class="kt-form" id="form-action" data-multipart='1' action="<?php echo $url; ?>/action_add/<?= $id ?>" autocomplete="off">
			<div class="row">
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" required name="mata_pengelihatan" class="form-control" value="Baik" placeholder="Mata Pengelihatan">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Hidung/Penciuman : <span class="required">*</span></label>
						<input type="text" required name="hidung_penciuman" class="form-control" value="Baik" placeholder="Hidung Penciuman">
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" required name="telinga_pendengaran" class="form-control" value="Baik" placeholder="Telinga Pendengaran">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Mulut : <span class="required">*</span></label>
						<input type="text" required name="mulut" class="form-control" value="Baik" placeholder="Mulut">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Gigi : <span class="required">*</span></label>
						<input type="text" required name="gigi" class="form-control" value="Baik" placeholder="Gigi">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Anggota Badan : <span class="required">*</span></label>
						<input type="text" required name="anggota_badan" class="form-control" value="Baik" placeholder="Anggota Badan">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Kulit : <span class="required">*</span></label>
						<input type="text" required name="kulit" class="form-control" value="Baik" placeholder="Kulit">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Kebersihan : <span class="required">*</span></label>
						<input type="text" required name="kebersihan" class="form-control" value="Baik" placeholder="Kebersihan">
					</div>
				</div>
				<div class="col-md-12">
					<div style="border: 1px solid #ccc;" id="roles" class="mb-3"></div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="number" required name="tb_awal" class="form-control" placeholder="">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Tinggi Badan Akhir Semester (cm): <span class="required">*</span></label>
						<input type="number" required name="tb_akhir" class="form-control">
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="number" required name="bb_awal" class="form-control" placeholder="">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Berat Badan Akhir Semester (Kg): <span class="required">*</span></label>
						<input type="number" required name="bb_akhir" class="form-control">
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="number" required name="lk_awal" class="form-control" placeholder="">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Lingkar Kepala Akhir Semester (cm): <span class="required">*</span></label>
						<input type="number" required name="lk_akhir" class="form-control">
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="number" required name="ll_awal" class="form-control" placeholder="">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Lingkar Lengan Akhir Semester (cm): <span class="required">*</span></label>
						<input type="number" required name="ll_akhir" class="form-control">
					</div>
				</div>
				<div class="col-md-12">
					<div style="border: 1px solid #ccc;" id="roles" class="mb-3"></div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" required name="imunisasi" class="form-control" value="Sudah" placeholder="">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Pemberian Kapsul Vitamin: <span class="required">*</span></label>
						<input type="text" required name="kapsul_vitamin" class="form-control" value="Sudah" placeholder="">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-control-label">Riwayat Penyakit: <span class="required">*</span></label>
						<textarea name="riwayat_penyakit" class="form-control">Tidak Ada</textarea>
					</div>
				</div>
				...
				<div class="col-md-12 text-center">
					<a href="<?php echo base_url(); ?>/kondisi_jasmani/index/<?= ($record->kelas_id); ?>" class="ajaxify btn btn-warning btn-elevate btn-square">Back</a>
