...
<head>
	...
	<title>Laporan Foto Berseri</title>
	...
	<div class="container bg-white sectiontoprint" id="sectiontoprint">
		<div class="col-md-12">
			...
			<div class="col-md-12 text-center">
					<h2>FOTO BERSERI</h2>
					<h3><?= $guru_sekolah->sekolah_nama ?></h3>
			...
			<div class="table-responsive">
				<table class="table text-center" style="border:none;" >
					...
					<tr>
						<td width="33%">Tanggal: <?= $foto_berseri[0]->tanggal ?></td>
						<td width="33%"></td>
			...
			<div class="table-responsive">
				<table class="table table-border" >
					...
					<tbody>
						<?php $i=0; foreach ($foto_berseri as $key => $value) : ?>
							<tr>
								<td width="15%">
									<?= $value->tanggal ?>
								</td>
								<td width="35%" class="text-center">
									<?php foreach ($foto as $ky => $val) {?>
										<img src="<?= base_url().$val->dokumentasi ?>" class="w-50">
									<?php } ?>
								</td>
								<td>
									<?= $value->pengamatan; ?>
								...
								<td width="25%">
									...
									<strong>Umpan Balik</strong>: <?= $value->umpan_balik ?>
								</td>
							</tr>
						<?php $i++; endforeach; ?>
					</tbody>
