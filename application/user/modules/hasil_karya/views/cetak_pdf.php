...
5=>'Khong Hucu',
            ...
            if (@$siswa==null) {
                ...
                $pdf->Cell(190,6,'HASIL KARYA', 0, 1, 'C');
                ...
                $pdf->Cell(50, 6, ': '.$siswa->no_induk, 0, 1, 'L', true);
                 ...
                 $semester= ($siswa->semester=='1') ? 'Ganjil' : 'Genap' ;
                ...
                $pdf->Cell(50, 6, ': '.tgl_indo( $hasil_karya[0]->tanggal), 0, 1, 'L', true);
                ...
                $text='';
                foreach ($hasil_karya as $key => $value) :
                    
                    $image = APPPATH. './../../user/'. $value->hasil_karya;
...
')); 
                    ...
                    $pdf->Rowimg(array($value->tanggal,$image, $value->pengamatan, $text));
               ...
               $pdf->ln(2);
                ...
                $pdf->Output("hasilkarya-".$siswa->no_induk.".pdf", "I");
