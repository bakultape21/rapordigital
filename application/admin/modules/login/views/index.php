				...
				<div class="m-5 row" style="background: white;">
					...
					<div class=" col-sm-6">
						...
						<div class=" mt-5">
							...
							<form class="row" action="<?php echo base_url(); ?>login/action" method="post">
								<div class="col-sm-6">
									<div class="input-group">
										<input class="form-control" type="text" autocomplete="off" placeholder="Username/Nip" name="username" autocomplete="off">
									</div>
					...
					<div class="col-sm-9">
						...
						<div class="col-sm-12">
							<label style="float: right;">Total Industri</label>
						</div>
					<!-- Carousel -->
