<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/pages/support-center/home-2.css">

<div class="kt-portlet kt-sc-2">
    <div class="kt-portlet__body">
        <div class="kt-sc__bg kt-sc__bg--layer">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 1200 172" style="enable-background:new 0 0 1200 172;" xml:space="preserve" class="kt-svg-icon">
        ...
        <div class="kt-sc__bg">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="e66d77ca-31e8-442d-a5de-b801817c4280" data-name="Layer 1" width="1024.7" height="671.65" viewBox="0 0 1024.7 671.65" class="kt-svg-icon">
    ...
    <div class="kt-sc__bottom">
        <a href="<?php echo $url; ?>" class="ajaxify btn btn-sm btn-warning btn-elevate btn-square"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
        <a href="<?php echo $url ?>/show_detail/<?php echo $id; ?>" class="ajaxify btn btn-sm btn-brand" aria-haspopup="true">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        <tbody>
                            ...
                            <tr>
                                <th>User Name</th>
                                <td><?php echo $record_data['username']; ?></td>
                            </tr>
                            <tr>
                                <th>Email</th>
                                <td><?php echo $record_data['email']; ?></td>
                            </tr>
                            <tr>
                                <th>Phone</th>
                            ...
                            <tr>
                                <th>Date of birth</th>
                                <td><?php echo $record_data['dateOfBirth'] ? date_format_indo($record_data['dateOfBirth']) : '-'; ?></td>
                            </tr>
                            <tr>
                                <th>Address</th>
                                <td><?php echo $record_data['address']; ?></td>
                            </tr>
                            <tr>
                                <th>Role</th>
                                <td>
                                    <p><span style="margin-right: 10px;"><span style="width: 150px; display: inline-block;">Name</span> :</span> <?php echo $record_data['role_user']['role_name']; ?></p>
                                    <p><span style="margin-right: 10px;"><span style="width: 150px; display: inline-block;">Code</span> :</span> <?php echo $record_data['role_user']['role_code']; ?></p>
                                    <p><span style="margin-right: 10px;"><span style="width: 150px; display: inline-block;">Companies Group</span> :</span> <?php echo $record_data['role_user']['role_companiesgroup']; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th>Companies Group</th>
                                <td>
                                    <p><span style="margin-right: 10px;"><span style="width: 150px; display: inline-block;">Name</span> :</span> <?php echo $record_data['companiesgroup_user']['companies_name']; ?></p>
                                    <p><span style="margin-right: 10px;"><span style="width: 150px; display: inline-block;">Code</span> :</span> <?php echo $record_data['companiesgroup_user']['companies_code']; ?></p>
                                    <p><span style="margin-right: 10px;"><span style="width: 150px; display: inline-block;">Address</span> :</span> <?php echo $record_data['companiesgroup_user']['companies_address']; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th>Status</th>
                                <td><?php echo $record_data['users_status']; ?></td>
                            </tr>
                            <tr>
                                <th>Desc</th>
                                <td><?php echo $record_data['status_description'] ? $record_data['status_description'] : '-'; ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
