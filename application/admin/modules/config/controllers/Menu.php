...
class Menu extends MX_Controller
{
	...
	public function action_add()
	{
		...
		$this->form_validation->set_rules('label', 'Label', 'trim|required|is_unique[t_menu.menu_label]');
		$this->form_validation->set_rules('link', 'Link', 'trim|required|is_unique[t_menu.menu_link]');
