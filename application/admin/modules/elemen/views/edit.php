			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select class="form-control" name="kelompok_id" required >
							<option value="<?= $record->kelompok_id ?>" selected><?= $record->nama_kelompok; ?></option>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="number" required name="nomor" class="form-control" value="<?= $record->nomor ?>" placeholder="Nomor">
					</div>
				</div>
				<div class="col-md-8">
					<div class="form-group">
