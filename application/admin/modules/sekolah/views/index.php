			...
			<table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
				<thead>
					<tr class="header">
						...
						<th>npsn</th>
						<th>Daerah</th>
						<th>Maksimal Register</th>
						<th width="120px">Guru Register</th>
...
<div class="modal fade" id="formCetak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" target="_blank" action="<?= site_url() ?>/sekolah/cetak">
        	<div class="form-group">
        	 ...
        	 <div class="form-group" style="display:none">
        		<label>Dari Register Tanggal</label>
        		<input type="text" name="awal" class="form-control datepicker">
        	</div>
        	<div class="form-group" style="display:none;">
        		<label>Sampai Register Tanggal</label>
