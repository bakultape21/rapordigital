			...
			<table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
				<thead>
					...
					<tr class="filter">
						<td></td>
						<td>
							<input type="text" name="judul" class="form-control form-control-sm form-filter" placeholder="Judul">
						</td>
						<td>
							<input type="text" name="isi_notifikasi" class="form-control form-control-sm form-filter" placeholder="isi notifikasi">
						</td>
...
<script type="text/javascript">
	...
	function hapus(id) {
		var cek = confirm("Anda Yakin Hapus Notifikasi?");
