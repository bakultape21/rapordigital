			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" required name="judul" class="form-control" value="<?= $record->judul ?>" placeholder="Judul">
					</div>
				</div>
				<div class="col-md-8">
					<div class="form-group">
						<label class="form-control-label">Isi Notifikasi : <span class="required">*</span></label>
						<textarea style="height: 200px;" class="form-control summernote" name="isi_notifikasi" required><?= $record->isi_notifikasi ?></textarea>
					</div>
				</div>				
