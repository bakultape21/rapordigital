					<div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed" style="background: #43aa58;">

						<!-- begin:: Aside -->
						<div class="kt-header__brand kt-grid__item" id="kt_header_brand">
							<div class="kt-header__brand-logo">
								<a href="<?php echo base_url(); ?>">
									<!-- <img width="50" alt="Logo" src="<?php echo base_url(); ?>./../assets/images/logo.svg" /> -->
								</a>
							</div>
						</div>
